...
/*package*/ class CSS_Ruleset_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new blockSingleRoleHandler_ttmz9d_b0(myNode, LINKS.block$GOB8, getEditorContext());
  ...
  private static class blockSingleRoleHandler_ttmz9d_b0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.block$GOB8, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.block$GOB8, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.block$GOB8);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.block$GOB8));
      try {
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept CSS_Selector$$7 = MetaAdapterFactory.getConcept(0xb38e874f4c8f43a4L, 0x92d8990b98e3c7abL, 0x19f6196be6f9735eL, "CSS.structure.CSS_Selector");
  }
}
